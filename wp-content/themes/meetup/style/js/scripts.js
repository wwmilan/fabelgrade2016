...
jQuery(window).load(function() { 
    ...
    jQuery(sponsors[0]).removeClass('col-md-2 col-sm-6').addClass('col-md-12 col-sm-12');
    ...
    organizationElInput.attr('disabled', 'disabled');
    jQuery('select[name="registration-type"]').change(function() {
      var value = jQuery(this).val();
      if (value === 'Organization' && organizationEl.hasClass('hidden')) {
        organizationEl.removeClass('hidden');
        organizationElInput.removeAttr('disabled');
      } else if (value != 'Organization' && !organizationEl.hasClass('hidden')) {
        organizationEl.addClass('hidden');
        organizationElInput.attr('disabled', 'disabled');
      }
    });
    var redBullUrl = "http://redbull.rs";
    var redBullTitle = "FabLab";
    jQuery('a[href="'+ redBullUrl +'"]').attr('title', redBullTitle);
    (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create', 'UA-46080369-3', 'auto', {'name': 'eventwidgetTracker'});ga('eventwidgetTracker.set', 'anonymizeIp', true);ga('eventwidgetTracker.set', 'dimension1', 'FabLab');ga('eventwidgetTracker.send', 'pageview');
}); 
